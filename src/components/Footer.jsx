        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="text-center lg:text-left">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={index}>
                  <a href="#" className="flex items-center justify-center lg:justify-start space-x-2 text-orange-200 hover:text-orange-100 transition-colors duration-200 group">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="space-y-4">
              <div className="flex justify-center lg:justify-start items-start space-x-3 text-orange-200">
                <MapPin className="w-5 h-5 mt-1 flex-shrink-0" />
                <p className="text-sm">
                  #2-2-168, Azad Road, Dist. Nalgonda, Telangana State - 508116
                </p>
              </div>
              <a href="tel:+1234567890" className="flex justify-center lg:justify-start items-center space-x-3 text-orange-200 hover:text-orange-100 transition-colors duration-200">
                <Phone className="w-5 h-5" />
                <span>+91 123 456 7890</span>
              </a>
              <a href="mailto:info@jaagruthi.edu" className="flex justify-center lg:justify-start items-center space-x-3 text-orange-200 hover:text-orange-100 transition-colors duration-200">
